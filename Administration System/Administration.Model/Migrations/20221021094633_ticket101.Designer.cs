...
namespace Model.Migrations
{
    ...
    [Migration("20221021094633_ticket101")]
    partial class ticket101
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Types.Task", b =>
                {
                    ...
                    b.Property<int?>("AdditionalValidationRulesFileId")
                        .HasColumnType("int");

                    b.Property<int?>("BaseValidationRulesFileId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AdditionalValidationRulesFileId");

                    b.HasIndex("BaseValidationRulesFileId");
            ...
            modelBuilder.Entity("Model.Types.Task", b =>
                {
                    b.HasOne("Model.Types.File", "AdditionalValidationRulesFile")
                        .WithMany()
                        .HasForeignKey("AdditionalValidationRulesFileId");

                    b.HasOne("Model.Types.File", "BaseValidationRulesFile")
                        .WithMany()
                        .HasForeignKey("BaseValidationRulesFileId");
                    ...
                    b.Navigation("AdditionalValidationRulesFile");

                    b.Navigation("BaseValidationRulesFile");
