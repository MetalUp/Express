...
namespace Model.Migrations
{
    ...
    [Migration("20221022161632_renamePropertiesInTask")]
    partial class renamePropertiesInTask
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Types.Task", b =>
                {
                    ...
                    b.Property<int?>("BaseRulesFileId")
                        .HasColumnType("int");

                    b.Property<int?>("DescriptionFileId")
                        .HasColumnType("int");

                    b.Property<int?>("ExtraRulesFileId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BaseRulesFileId");

                    b.HasIndex("DescriptionFileId");

                    b.HasIndex("ExtraRulesFileId");
            ...
            modelBuilder.Entity("Model.Types.Task", b =>
                {
                    b.HasOne("Model.Types.File", "BaseRulesFile")
                        .WithMany()
                        .HasForeignKey("BaseRulesFileId");
                    ...
                    b.HasOne("Model.Types.File", "ExtraRulesFile")
                        .WithMany()
                        .HasForeignKey("ExtraRulesFileId");
                    ...
                    b.Navigation("BaseRulesFile");

                    b.Navigation("DescriptionFile");

                    b.Navigation("ExtraRulesFile");
